...
| `AI_BATCH_HISTORY.jsonl` | Local AI batch history with job status and daily brief path |
| `AI_DAILY_BRIEF.md` | Daily brief generated by Local App batch AI analysis |
...
- AI analysis follow-ups: the Local App now has templates, provider profiles, connection diagnostics, multi-scope analysis, evidence preview, structured output, source citations, history caching, batch AI analysis, `AI_DAILY_BRIEF.md`, profile comparison, cost estimation, and rule-vs-AI checks. Next steps are a CLI AI entrypoint and market-data alpha feedback.
