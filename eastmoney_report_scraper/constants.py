...
DEFAULT_AI_HISTORY_NAME = "AI_ANALYSIS_HISTORY.jsonl"
DEFAULT_AI_ANALYSIS_DIR_NAME = "AI_ANALYSES"
DEFAULT_AI_BATCH_HISTORY_NAME = "AI_BATCH_HISTORY.jsonl"
DEFAULT_AI_DAILY_BRIEF_NAME = "AI_DAILY_BRIEF.md"
QTYPE_STOCK = 0
QTYPE_INDUSTRY = 1
QTYPE_ALL = 2
QTYPE_NAMES = {
