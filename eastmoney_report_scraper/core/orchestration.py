"""Reusable orchestration for CLI, OpenClaw, and the local app."""
...
def run_fetch_workflow(date_values: List[str], output_root: Path, args: argparse.Namespace) -> Dict[str, Any]:
    """Run the full fetch/export workflow and return the final JSON payload."""
